function [E,V] = lapbin(DATA,lodim,nn,step,stepsbtwnreport,opts)

% LAPHEAT Laplacian Eigenmaps Algorithm with binary weights.
%
...
[E,V] = laplacian_underlying(DATA,lodim,nn,step,stepsbtwnreport,opts,0,1,0);
